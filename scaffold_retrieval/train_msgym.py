...
if __name__ == "__main__":
    ...
    with open('params_msg.yaml') as f:
    ...
    if os.path.exists("molgraph_dict_msgym_scaff.pkl"):
        with open(os.path.join("molgraph_dict_msgym_scaff.pkl"), 'rb') as f:
    ...
    if os.path.exists(data_path+"cand_dict_large_form.pkl"):
        with open(os.path.join(data_path, "cand_dict_large_form.pkl"), 'rb') as f:
    ...
    with open(os.path.join('molgraph_dict_msgym_scaff.pkl'), 'wb') as f:
