...
class SnCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)


class CuCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)


class MgCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)


class ZnCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)
        
class CoCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)

class KCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)
        
class FeCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)  
 
class CrCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)  

class NaCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)  
...
class AuCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)  
        
class GdCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)  
        
class SbCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)  
        
class DummyCE(CEPerClass):
    def __init__(self, i):
        super().__init__(i)
...
class AtomMetricsCE(MetricCollection):
    def __init__(self, dataset_infos):
        ...
        class_dict = {
            ...
            'Si': SiCE, 'Sn': SnCE, 'Mg': MgCE, 'Cu': CuCE, 'Zn': ZnCE, 'Co': CoCE, 'K': KCE, 
            'Fe': FeCE, 'Cr': CrCE, 'Na': NaCE, 'Al': AlCE, 'As': AsCE, 'Mg': MgCE, 'Au': AuCE,
            'Gd': GdCE, 'Sb': SbCE, '*': DummyCE,
        }
...
class DummyTrainMolecularMetricsDiscrete(nn.Module):
    def __init__(self):
        super().__init__()
